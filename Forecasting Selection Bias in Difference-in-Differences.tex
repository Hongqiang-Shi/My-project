...
\begin{table}[h]
    ...
    \begin{tabular}{cccccc}\toprule
         \multicolumn{2}{c}{June - July}&  \multicolumn{4}{c}{Construction of simulation framework and baseline data-generating processes. Then Implementation of forecasting models and bias-correction estimators}\\\midrule
         \multicolumn{2}{c}{August - September}&  \multicolumn{4}{c}{Empirical application using André’s replication data}\\\midrule
 \multicolumn{2}{c}{October - December}& \multicolumn{4}{c}{Interpretation of results and thesis finishing}\\ \bottomrule
    \end{tabular}  
\end{table}
